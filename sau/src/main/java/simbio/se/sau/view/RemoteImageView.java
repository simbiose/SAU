...
public class RemoteImageView extends ImageView {
     ...
     *
     * @param imageUrl a {@link String} with the url to be getted
     * @since {@link API#Version_3_1_2}
     */
    ...
    /**
     * @param defaultImage the int resource id to set the Default image
     * @since {@link API#Version_3_1_2}
     */
    ...
    /**
     * @param errorImage the int resource id to set the Error image if downloads fails
     * @since {@link API#Version_3_1_2}
     */
