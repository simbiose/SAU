 ...
 */
package simbio.se.sau.view.interfaces;

import simbio.se.sau.API;
import simbio.se.sau.view.RangeSeekBar.OnRangeSeekBarChangeListener;

/**
 * @author Ademar Alves de Oliveira (ademar111190@gmail.com)
 * @date 2013-sep-30 01:48:25
 * @since {@link API#Version_2_0_0}
 */
public interface IRangeSeekBar<T extends Number> extends OnRangeSeekBarChangeListener<T> {
