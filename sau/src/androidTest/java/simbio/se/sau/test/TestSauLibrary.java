...
public class TestSauLibrary extends AndroidTestCase {
    ...
    public final void testSomething() {
        ...
        Foo objectPreferencesValueValidateWithDef = (Foo) preferences
                .getObject(keyObject, Foo.class, objectPreferencesValue);
        Foo objectPreferencesValueValidateWithDefDifferent = (Foo) preferences
                .getObject(keyObject, Foo.class, fooDifferent);
        Foo objectPreferencesValueValidateWithoutDef = (Foo) preferences
                .getObjectOrNull(keyObject, Foo.class);
        Foo objectPreferencesValueValidateWithDefMock = (Foo) preferences
                .getObject(keyMockObject, Foo.class, objectPreferencesValue);
        Foo objectPreferencesValueValidateWithDefDifferentMock = (Foo) preferences
                .getObject(keyMockObject, Foo.class, fooDifferent);
        Foo objectPreferencesValueValidateWithoutDefMock = (Foo) preferences
                .getObjectOrNull(keyMockObject, Foo.class);
        String stringPreferencesValueValidateWithDef = preferences
                .getString(keyString, stringPreferencesValue);
        String stringPreferencesValueValidateWithDefEmpty = preferences
                .getStringOrEmpty(keyString);
        String stringPreferencesValueValidateWithoutDef = preferences
                .getStringOrNull(keyString);
        String stringPreferencesValueValidateWithDefMock = preferences
                .getString(keyMockString, stringPreferencesValue);
        String stringPreferencesValueValidateWithDefEmptyMock = preferences
                .getStringOrEmpty(keyMockString);
        String stringPreferencesValueValidateWithoutDefMock = preferences
                .getStringOrNull(keyMockString);
        ...
        boolean booleanPreferencesValueValidateFalse = preferences
                .getBooleanOrTrue(keyBooleanFalse);
        boolean booleanPreferencesValueValidateTrueMock = preferences
                .getBooleanOrFalse(keyMockBoolean);
        boolean booleanPreferencesValueValidateFalseMock = preferences
                .getBooleanOrTrue(keyMockBoolean);
        @SuppressWarnings("unchecked")
        ArrayList<Foo> arrayListPreferencesValueValidateWithDef = (ArrayList<Foo>) preferences
                .getObject(keyArray, type, arrayListPreferencesValue);
        @SuppressWarnings("unchecked")
        ArrayList<Foo> arrayListPreferencesValueValidateWithDefDifferent = (ArrayList<Foo>)
                preferences.getObject(keyArray, type, arrayListDifferent);
        @SuppressWarnings("unchecked")
        ArrayList<Foo> arrayListPreferencesValueValidateWithoutDef = (ArrayList<Foo>) preferences
                .getObjectOrNull(keyArray, type);
        @SuppressWarnings("unchecked")
        ArrayList<Foo> arrayListPreferencesValueValidateWithDefMock = (ArrayList<Foo>) preferences
                .getObject(keyMockArray, type, arrayListPreferencesValue);
        @SuppressWarnings("unchecked")
        ArrayList<Foo> arrayListPreferencesValueValidateWithDefDifferentMock = (ArrayList<Foo>)
                preferences.getObject(keyMockArray, type, arrayListDifferent);
        @SuppressWarnings("unchecked")
        ArrayList<Foo> arrayListPreferencesValueValidateWithoutDefMock = (ArrayList<Foo>)
                preferences.getObjectOrNull(keyMockArray, type);
        ...
        assertEquals(
                objectPreferencesValueValidateWithDef.valueFloat,
                objectPreferencesValue.valueFloat
        );
        assertEquals(
                objectPreferencesValueValidateWithDef.valueInt,
                objectPreferencesValue.valueInt
        );
        assertEquals(
                objectPreferencesValueValidateWithDef.valueString,
                objectPreferencesValue.valueString
        );
        assertEquals(
                objectPreferencesValueValidateWithDef.valuesDouble[0],
                objectPreferencesValue.valuesDouble[0]
        );
        assertEquals(
                objectPreferencesValueValidateWithDef.valuesDouble[1],
                objectPreferencesValue.valuesDouble[1]
        );
        assertEquals(
                objectPreferencesValueValidateWithDefDifferent.valueFloat,
                objectPreferencesValue.valueFloat
        );
        assertEquals(
                objectPreferencesValueValidateWithDefDifferent.valueInt,
                objectPreferencesValue.valueInt
        );
        assertEquals(
                objectPreferencesValueValidateWithDefDifferent.valueString,
                objectPreferencesValue.valueString
        );
        assertEquals(
                objectPreferencesValueValidateWithDefDifferent.valuesDouble[0],
                objectPreferencesValue.valuesDouble[0]
        );
        assertEquals(
                objectPreferencesValueValidateWithDefDifferent.valuesDouble[1],
                objectPreferencesValue.valuesDouble[1]
        );
        assertEquals(
                objectPreferencesValueValidateWithoutDef.valueFloat,
                objectPreferencesValue.valueFloat
        );
        assertEquals(
                objectPreferencesValueValidateWithoutDef.valueInt,
                objectPreferencesValue.valueInt
        );
        assertEquals(
                objectPreferencesValueValidateWithoutDef.valueString,
                objectPreferencesValue.valueString
        );
        assertEquals(
                objectPreferencesValueValidateWithoutDef.valuesDouble[0],
                objectPreferencesValue.valuesDouble[0]
        );
        assertEquals(
                objectPreferencesValueValidateWithoutDef.valuesDouble[1],
                objectPreferencesValue.valuesDouble[1]
        );
        assertEquals(
                objectPreferencesValueValidateWithDefMock.valueFloat,
                objectPreferencesValue.valueFloat
        );
        assertEquals(
                objectPreferencesValueValidateWithDefMock.valueInt,
                objectPreferencesValue.valueInt
        );
        assertEquals(
                objectPreferencesValueValidateWithDefMock.valueString,
                objectPreferencesValue.valueString
        );
        assertEquals(
                objectPreferencesValueValidateWithDefMock.valuesDouble[0],
                objectPreferencesValue.valuesDouble[0]
        );
        assertEquals(
                objectPreferencesValueValidateWithDefMock.valuesDouble[1],
                objectPreferencesValue.valuesDouble[1]
        );
        assertEquals(
                objectPreferencesValueValidateWithDefDifferentMock.valueFloat,
                fooDifferent.valueFloat
        );
        assertEquals(
                objectPreferencesValueValidateWithDefDifferentMock.valueInt,
                fooDifferent.valueInt
        );
        assertEquals(
                objectPreferencesValueValidateWithDefDifferentMock.valueString,
                fooDifferent.valueString
        );
        assertEquals(
                objectPreferencesValueValidateWithDefDifferentMock.valuesDouble[0],
                fooDifferent.valuesDouble[0]
        );
        assertEquals(
                objectPreferencesValueValidateWithDefDifferentMock.valuesDouble[1],
                fooDifferent.valuesDouble[1]
        );
        ...
        assertTrue(assertFooArrayList(
                arrayListPreferencesValue,
                arrayListPreferencesValueValidateWithDef
        ));
        assertTrue(assertFooArrayList(
                arrayListPreferencesValue, arrayListPreferencesValueValidateWithDefDifferent
        ));
        assertTrue(assertFooArrayList(
                arrayListPreferencesValue, arrayListPreferencesValueValidateWithoutDef
        ));
        assertTrue(assertFooArrayList(
                arrayListPreferencesValue, arrayListPreferencesValueValidateWithDefMock
        ));
        assertTrue(assertFooArrayList(
                arrayListDifferent, arrayListPreferencesValueValidateWithDefDifferentMock
        ));
