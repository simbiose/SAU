...
public enum RangeSeekBarNumberType {
    ...
    /**
     * @param value a {@link Number} instance to be get your {@link RangeSeekBar} type
     * @return the {@link RangeSeekBar} type of your {@link Number}
     * @throws IllegalArgumentException if you send a non supported {@link Number}
     * @since {@link API#Version_2_0_0}
     */
    public static <E extends Number> RangeSeekBarNumberType fromNumber(E value)
    ...
    /**
     * @param value to be converted to a {@link Number}
